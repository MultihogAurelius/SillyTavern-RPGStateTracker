...
1. **Initial Setup:** Use the archetype buttons on the empty tracker to roll a new character, or paste an existing sheet into the "Raw View" (⊞) (if your sheet doesn't work align, ask the model via 💬 to fix the formatting.) Create a character card for your "narrator," such as Simulation Engine that I use. You can also name it something like Game Master.
